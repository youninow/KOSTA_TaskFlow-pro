...
## MVP 완료 기준 체크 `✅ 2026-05-14 선언`

| 항목 | 결과 | 검증 근거 |
|------|------|----------|
| 새로고침 후 데이터 유지 | ✅ | SQLite DB 영속 확인 (태스크 4건 유지) |
| 360px 레이아웃 깨짐 없음 | ✅ | DevTools 360px 뷰 확인 |
| API 응답 200ms 이내 | ✅ | 127.0.0.1 기준 평균 8.9ms |
| CRUD 4종 화면 동작 | ✅ | 추가·수정·삭제·목록 E2E 시나리오 통과 |
| 테마 토글 + 새로고침 유지 | ✅ | localStorage 저장·복원 코드 확인 |
| due_at 시간 단위 저장·표시 | ✅ | `2026-05-20T09:00:00` DB 저장·조회 확인 |
